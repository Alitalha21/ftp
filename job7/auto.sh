...
sudo cat /home/ali/job7/conf.proftpd > /etc/proftpd/proftpd.conf
sudo cat /home/ali/job7/conf.tls > /etc/proftpd/tls.conf
sudo cat /home/ali/job7/conf.modules > /etc/proftpd/modules.conf
